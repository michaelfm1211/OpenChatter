...
// This file declares many constants which are used for configuration
...
define("POLLING_RATE", 500);	// How often the client should poll the server for new messages in milliseconds. Reasonable times are 1000(once a second), or for a snappier site 500(twice a second), or if you're the millitary or something 100(ten times a second). Remember, more times a second results in heavier workload for the server, which may slow everything down